 ...
 * @author Alberto
 */
@WebServlet(name = "ActivacionBicicletaActivadas", urlPatterns = {"/ActivacionBicicletaActivadas"})
public class ActivacionBicicletaActivadas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            String url = "/RecuperarBicicletasActivas";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ActivacionBicicletaActivadas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
