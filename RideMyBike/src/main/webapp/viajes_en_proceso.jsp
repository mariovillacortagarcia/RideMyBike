                        ...
                        <ul class="list-group overflow-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="container pb-2">
                                                <p class="text-secondary">No se puede puntuar todav�a </p>
                                            </div>
                                            <div class="dropdown">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="alert alert-light" role="alert">
                                    No hay ning�n viaje en proceso
                                </div>
                            </li>
                            <% }%>
                            <li class="list-group-item">
                                ...
                                <div class="alert alert-secondary bg-white" role="alert">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p>
                                                Desde el 25 de julio de 2020 a las 10:00 <br>
                                            </p>
                                            <p>
                                                <a class="text-secondary">Estimado: </a><b>3,50 €</b>
                                            </p>
                                        </div>
                                        <div class="col-3">
                                            <!--Precio y valoracion-->
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="alert alert-secondary bg-white" role="alert">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <!--Informacion del viaje-->
                                            <h6 class=""><a class="text-secondary">Pendiente: </a><b>Plaza Mayor, Valladolid - Plaza Mayor, Palencia</b></h6>
                                            <p>
                                                Desde el 26 de julio de 2020 a las 10:00 <br>
                                            </p>
                                            <p>
                                                <a class="text-secondary">Estimado: </a><b>5,55 €</b>
                                            </p>
                                        </div>
                                        <div class="col-3">
                                            <!--Precio y valoracion-->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="#">Iniciar viaje</a>
                                                    <a class="dropdown-item" href="registrar_incidencia.html">Registrar incidencia</a>
                                                    <a class="dropdown-item" href="#">Cancelar viaje</a>
