...
<html>
    ...
    <body>
        ...
        <jsp:include page="header.jsp" >
            <jsp:param name="paginaMostrada" value="IncidenciasBicicleta" />
                    ...
                    <table class="table table-bordered" bordercolor="black">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=descripcion%></td>
                                <td>
                                    <a type="button" class="btn btn-success" href="SolucionarIncidenciaDesdeBici?codigoIncidencia=<%= incidencia.getCodigoIncidencia()%>&codigoBicicleta=<%=request.getAttribute("codigoBicicleta")%>">Solucionar</a>
                                </td>
                            </tr>
                            <% }%>
                        </tbody>
