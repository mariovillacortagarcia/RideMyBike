...
<html lang="es">
    ...
    <body>
        ...
        <!-- Contenido -->
        <%
            Bicicleta biciAValorar = (Bicicleta) request.getAttribute("biciAValorar");
            String codigoAlquiler = request.getAttribute("codigoAlquiler").toString();
        %>
        <div class="container pt-4 mt-1">
            <!--Formulario de Registro de una valoracion de bicicleta-->
            <div class="alert alert-secondary bg-white row" role="alert">
                <img src="RecuperarImagenBicicleta?idBici=<%= biciAValorar.getcodigoBici() %>"  alt="Imagen de la bici" class="img-thumbnail col-3">
                <div class="col-9">
                    <h3>¡Puntúa la bici <%= biciAValorar.getMarca() %> <%= biciAValorar.getModelo() %>!</h3>
                    <div class="mb-2">
